v<?php
class TCS_Form_FormUsuario extends Zend_Form {
    ...
    public function init() {
        ...
        $this->setAction('');
        $this->setMethod('post');
        $this->setAttribs(array('id' => 'FormUsuario', 'nome' => 'FormUsuario', 'enctype' => 'multipart/form-data'));
       ...
       // tipo das usuarios .......................................................................
        ...
        $this->addElement($elemento);
        $this->addDisplayGroup(array('id', 'nome', 'login', 'senha', 'email', 'celular', 'perfil', 'imagem', 'status', 'Salvar'), 'usuarios', array('removeDecorator' => 'Label'));
